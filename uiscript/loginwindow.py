...
#################################################################################################################
		{
			...
			(
				...
				},
				{
					name:'Title',
					type:types.text,
					text.text:'Digite seus dados para entrar',
...
#################################################################################################################
		{
			...
			'children':
			(
				{name:'',type:'text','text':'Tem certeza que deseja remover a conta abaixo?','x':0,'y':42,horizontal_align:'center',text.align.horizontal:'center',},
				{name:'DeleteAccountBoardAccount',type:'text','text':'','x':0,'y':42+15,horizontal_align:'center',text.align.horizontal:'center','fontsize':'LARGE',},
				{
