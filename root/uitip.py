...
class BigBoard(ui.Bar):
	...
	FRAME_IMAGE_FILE_NAME_LIST = [
		"interface/controls/special/oxevent/frame_0.sub",
		"interface/controls/special/oxevent/frame_1.sub",
		"interface/controls/special/oxevent/frame_2.sub",
	]
...
class GrandeAvisoBar(ui.Window):
	def __init__(self, width, height):
		ui.Window.__init__(self)
		self.handle = grp.CreateTextBar(width, height)
...
class GrandeAvisoBoard(ui.Bar):
	...
	def __CreateTextBar(self):
		...
		self.textBar = GrandeAvisoBar(wndMgr.GetScreenWidth(), 300)
		self.textBar.SetParent(self)
